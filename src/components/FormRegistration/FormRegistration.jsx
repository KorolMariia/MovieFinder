...
export default function FormRegistration() {
  ...
  const onSubmit = (data) => {dispatch(saveUserName(data.username))};
  ...
  return (
    <div className="registrarion_box">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="user_box">
          <input 
            {...register("username", { required: true,  pattern: /^[a-z][a-zA-Z\d_\.]*$/g })}
            className="user_box-input"
            type="text"
          ...
          {errors?.username?.type === "pattern" && (<p className="error-long">
            The username is guilty of small letters <br/> and consists of only letters, numbers, 
            <br/>special characters: . or _</p>)}
        </div>
        <div className="user_box">
          <input 
        ...
        <div className="user_box">
          ...
          {errors.confirmpassword?.type === "validate" && <p className="error">Your passwords don't match</p>}
        </div>
        <div className="user_box">
          <input 
          ...
          {errors.dateofbirth?.type === "required" && <p className="error">This field is required</p>}
        </div>
        <div className="user_box">
          <div  className="user_box-input">
            <input type="radio" id="male" name="gender"  {...register("sex", { required: true })}/>
            <label htmlFor="male" className="radio" >Male</label>
            <input type="radio" id="female" name="gender"  {...register("sex", { required: true })}/>
            <label htmlFor="female" className="radio">Female</label>
            <input type="radio" id="other" name="gender"  {...register("sex", { required: true })}/>
            <label htmlFor="other" className="radio">Other</label>
          </div>
          <label className="user_box-label">Sex</label>
          {errors.sex?.type === "required" && <p className="error">This field is required</p>}
        </div>
         <ButtonRegistration />
      </form>
    </div>
